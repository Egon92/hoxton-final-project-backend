...
INSERT INTO "new_Project" ("category_id", "deadline", "description", "employee_id", "employer_id", "id", "price", "status", "title") SELECT "category_id", "deadline", "description", "employee_id", "employer_id", "id", "price", "status", "title" FROM "Project";
DROP TABLE "Project";
